...
class hackathon():
    ...
    def initialize(self):
        ...
        self.model.engine = {}
        with open("/home/player/ControlNet/my_file/dynamic/controlnet.plan", 'rb') as f:
            engine_str = f.read()
        self.model.engine['control_net'] = trt.Runtime(self.trt_logger).deserialize_cuda_engine(engine_str)
        
        with open("/home/player/ControlNet/my_file/dynamic/unet.plan", 'rb') as f:
            engine_str = f.read()
        self.model.engine['unet'] = trt.Runtime(self.trt_logger).deserialize_cuda_engine(engine_str)
        
        with open("/home/player/ControlNet/my_file/dynamic/clip.plan", 'rb') as f:
            engine_str = f.read()
        self.model.engine['clip'] = trt.Runtime(self.trt_logger).deserialize_cuda_engine(engine_str)
        
        with open("/home/player/ControlNet/my_file/dynamic/vae.plan", 'rb') as f:
            engine_str = f.read()
